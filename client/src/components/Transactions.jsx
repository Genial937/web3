    ...
    ">
      <div className="flex flex-col items-center w-full m-3">
        <div className="w-full mb-6 p-2">
          <a href={`https://rinkeby.etherscan.io/address/${addressFrom}`} className="" target="_blank" rel="noopener noreferrer">
            <p className="text-white text-base">From: {shortenAddress(addressFrom)}</p>
          </a>
          <a href={`https://rinkeby.etherscan.io/address/${addressTo}`} className="" target="_blank" rel="noopener noreferrer">
    ...
    <div className='flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions'>
      <div className="flex flex-col md:p-12 py-12 px-4">
        ...
        <div className="flex flex-wrap justify-center items-center mt-10">
          {transactions && transactions.reverse().map((transaction, index) => (
